   ...
   <!--  <div class="btn-toolbar">
        ...
        <div class="panel-body">
            <div class="form-horizontal row-border">
               ...
               <form method="post" action="<?php echo base_url(); ?>upload/update_visi/1">

                  <?php
                            
                                 foreach ($visi->result() as $x)
                            
                                          ?>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Isi Visi Misi </label>
                    <div class="col-sm-8">
                     <textarea class="form-control" name="isi_visi"><?php echo $x->visi_misi;?></textarea>
                    </div>
                </div>
